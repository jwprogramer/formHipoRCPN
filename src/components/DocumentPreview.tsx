...
export const DocumentPreview: React.FC<DocumentPreviewProps> = ({ form, documentRef }) => {
  return (
    <div ref={documentRef} id="official-doc-print-area" className="official-document-wrapper">
      {/* ============================================================== */}
      {/* PÁGINA 1 DE 2                                                  */}
      {/* ============================================================== */}
      <div className="a4-page page-1 shadow-lg bg-white relative">
        {/* Cabeçalho Oficial */}
        <div className="header-line flex justify-between items-center pb-2 mb-2 border-b-2 border-[#004a80]">
          <div className="flex items-center">
            <img 
              src="/imagens/tjrn.webp" 
        ...
        <div className="text-center mt-1">
          <div className="font-bold text-gray-700 text-[11px] tracking-widest uppercase">
        ...
        {/* Box Informativo */}
        <div className="info-blue-box bg-[#f0f7ff] rounded-md p-2 flex gap-2.5 my-2 border-l-4 border-[#004a80] text-[9.5px] leading-snug">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Serventia:</span>
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1.5 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Município/Comarca:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Nome completo *:</span>
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-7 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">CPF ou RG *:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
              {form.beneficiarioDocumento || ''}
            </span>
          </div>
          <div className="col-span-5 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Data de nascimento:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Profissão:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Endereço *:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-8 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Município/UF *:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
              {form.beneficiarioMunicipioUF || ''}
            </span>
          </div>
          <div className="col-span-4 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">CEP:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1.5 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Telefone ou e-mail:</span>
            <span className="input-line border-b border-black text-[10.5px] font-medium flex-grow px-1 min-h-[18px]">
        ...
        <div className="text-[9.5px] text-slate-600 px-1 mb-1 font-medium">
        ...
        <div className="grid grid-cols-12 gap-2 px-1 mb-1">
          <div className="col-span-8 space-y-1.5 text-[9.5px] leading-tight">
            <div className="flex items-start gap-1.5">
              <span className={`w-3.5 h-3.5 border border-black flex items-center justify-center text-[10px] font-bold leading-none select-none shrink-0 ${form.atoCertidao ? 'bg-slate-900 text-white' : 'bg-white'}`}>
                {form.atoCertidao ? 'X' : ''}
              </span>
              <span className="font-bold text-slate-900">Certidão de nascimento, casamento, óbito ou outra</span>
            </div>
            ...
            <div className="flex items-center gap-3 ml-5 font-bold text-[#004a80] uppercase text-[8.5px]">
              ...
              <label className="font-normal text-black flex items-center gap-1 select-none">
                <span className={`w-3 h-3 border border-black flex items-center justify-center text-[9px] font-bold ${form.certidaoTipos.semBusca ? 'bg-slate-900 text-white' : 'bg-white'}`}>
                  {form.certidaoTipos.semBusca ? 'X' : ''}
                </span>
                Sem busca
              </label>
              <label className="font-normal text-black flex items-center gap-1 select-none">
                <span className={`w-3 h-3 border border-black flex items-center justify-center text-[9px] font-bold ${form.certidaoTipos.comBusca ? 'bg-slate-900 text-white' : 'bg-white'}`}>
                  {form.certidaoTipos.comBusca ? 'X' : ''}
                </span>
                Com busca
              </label>
              <label className="font-normal text-black flex items-center gap-1 select-none">
                <span className={`w-3 h-3 border border-black flex items-center justify-center text-[9px] font-bold ${form.certidaoTipos.inteiroTeor ? 'bg-slate-900 text-white' : 'bg-white'}`}>
            ...
            <div className="flex items-start gap-1.5">
              <span className={`w-3.5 h-3.5 border border-black flex items-center justify-center text-[10px] font-bold leading-none select-none shrink-0 ${form.atoHabilitacaoCasamento ? 'bg-slate-900 text-white' : 'bg-white'}`}>
                {form.atoHabilitacaoCasamento ? 'X' : ''}
              </span>
              <span className="font-bold text-slate-900">Habilitação, registro de casamento e primeira certidão</span>
            </div>

            <div className="flex items-start gap-1.5">
              <span className={`w-3.5 h-3.5 border border-black flex items-center justify-center text-[10px] font-bold leading-none select-none shrink-0 ${form.atoAlteracaoPrenomeGenero ? 'bg-slate-900 text-white' : 'bg-white'}`}>
            ...
            <div className="flex items-start gap-1.5">
              <span className={`w-3.5 h-3.5 border border-black flex items-center justify-center text-[10px] font-bold leading-none select-none shrink-0 ${form.atoOutro ? 'bg-slate-900 text-white' : 'bg-white'}`}>
                {form.atoOutro ? 'X' : ''}
              </span>
              <span className="font-bold text-slate-900">Outro ato com previsão legal</span>
            </div>
          </div>

          {/* Dados para localizar o ato */}
          <div className="col-span-4 border border-slate-300 p-2 rounded text-[9.5px] bg-[#fafafa]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">
        ...
        <div className="text-[9.5px] text-justify px-1 space-y-1 text-slate-800 leading-relaxed font-normal">
        ...
        {/* Rodapé Página 1 */}
        <div className="footer-text mt-auto pt-2 border-t border-slate-300 flex justify-between items-center text-[9px] text-slate-600">
          <span>Edição disponibilizada em 08/09/2026</span>
          <span className="font-mono text-slate-400">000086910</span>
      ...
      {/* PÁGINA 2 DE 2                                                  */}
      {/* ============================================================== */}
      <div className="a4-page page-2 shadow-lg bg-white relative page-break-before">
        {/* Cabeçalho Página 2 */}
        <div className="header-line flex justify-between items-center pb-2 mb-2 border-b-2 border-[#004a80]">
        ...
        <div className="text-[9px] text-gray-600 mb-2 font-medium">
        ...
        <div className="grid grid-cols-2 gap-8 px-2 mt-2 mb-3">
          <div className="flex flex-col justify-end">
            <div className="flex items-baseline">
              <span className="field-label text-[10.5px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Local e data *:</span>
          ...
          <div className="signature-box flex flex-col items-center justify-end">
            ...
            <div className="w-full border-t border-black text-center text-[10px] pt-1 font-medium text-slate-900">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Nome completo:</span>
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-6 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">CPF ou RG:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
              {form.temRepresentante ? form.representanteDocumento : ''}
            </span>
          </div>
          <div className="col-span-6 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Telefone/e-mail:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Documento comprobatório:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
        ...
        <div className="flex justify-between items-end mt-2 px-1">
          <div className="text-[8px] italic w-1/2 text-slate-700 leading-snug">
          ...
          <div className="signature-box w-2/5 flex flex-col items-center">
            ...
            <div className="w-full border-t border-black text-center text-[9px] pt-1 font-medium text-slate-900">
        ...
        <div className="text-[9px] px-1 text-slate-700 font-medium">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mt-1 mb-1 px-1">
          <div className="col-span-12 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Nome de quem assina a rogo:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
        ...
        <div className="flex justify-between items-end px-1 mt-2">
          ...
          <div className="thumb-box w-[75px] h-[75px] border border-dashed border-slate-600 rounded text-[7.5px] flex flex-col items-center justify-center text-center p-1 text-slate-600">
        ...
        <div className="grid grid-cols-2 gap-3 px-1 mt-1">
          <div className="border border-slate-300 p-1.5 rounded text-[9px] bg-[#fafafa]">
        ...
        <div className="text-[8.5px] px-1 text-slate-700 leading-tight text-justify font-medium">
        ...
        <div className="grid-row grid grid-cols-12 gap-2 mt-1 mb-1 px-1">
          <div className="col-span-6 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Local e data:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
              {form.certificacaoLocalData || ''}
            </span>
          </div>
          <div className="col-span-6 flex items-baseline">
            <span className="field-label text-[10px] font-bold text-slate-800 mr-1.5 whitespace-nowrap">Oficial ou preposto:</span>
            <span className="input-line border-b border-black text-[10px] font-medium flex-grow px-1 min-h-[17px]">
        ...
        <div className="signature-box w-3/5 mx-auto mt-8 flex flex-col items-center">
          ...
          <div className="w-full border-t border-black text-center text-[9.5px] pt-1.5 font-medium text-slate-900">
            Assinatura e identificação funcional
          </div>
        </div>

        {/* Rodapé Página 2 com Base Normativa */}
        <div className="footer-text mt-auto pt-1.5 border-t border-slate-300">
          <div className="flex gap-2.5 border-t-2 border-[#004a80] pt-1">
            <div className="text-lg leading-none select-none">📄</div>
            <div className="text-[7.5px] leading-tight text-justify text-slate-700">
          ...
          <div className="flex justify-between items-center mt-1 text-[8.5px] text-slate-600">
